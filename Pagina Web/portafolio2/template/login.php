...
<head>
    ...
    <title>Login Cliente - FERME</title>
...
<body class="text-center">
    <form class="form-signin" id="frmLogin">
        <img class="mb-4" src="https://icon-icons.com/icons2/1090/PNG/72/settings_78352.png" alt="" width="72"
            height="72">
        <h1 class="h3 mb-3 font-weight-normal">Ingreso Cliente</h1>
		...
		<button class="btn btn-lg btn-block" type="submit"><a href="registro.php">Registrarse</a></button>
        <br>
        <a href="Cliente_Empresa.php">Volver</a>
    </form>
</body>
