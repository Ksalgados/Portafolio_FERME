...
<body class="text-center">
    <form class="form-signin" id="frmRegistro">
        ...
        <input type="text" class="form-control" placeholder="Ingrese su e-mail" name="usuario" id="usuario" required autofocus>
        <BR>
		...
		$('#registro').click(function(){
			...
			if(vacios > 0){
				...
				$.ajax({
					type:"POST",
					data:datos,
					url:"../../procesos/regLogEmp/registrarUsuario.php",
					success:function(r){
						if(r==1){
							...
							alert("Email ya registrado \npor favor intente con otro mail o inicie sesion");
						}
					}
				});
			}
