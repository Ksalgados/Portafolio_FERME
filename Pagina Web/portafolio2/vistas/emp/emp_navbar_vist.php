<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand" href="emp_inicio.php">Ferreteria FERME</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="emp_ini.php">Productos<span class="sr-only">(current)</span></a>
            </li>
        ...
        <a class="btn btn-outline-success my-1 my-sm-0" href="emp_carrito_vist.php" style="background:url(../../img/carrito.png) no-repeat; border:none; width:32px; height:32px;" ></a>
        </form>
        </li>
        <li class="nav-item">
            <div class="btn-group" role="group">
                ...
                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                    <a class="dropdown-item" href="emp_micuenta.php">Mi Cuenta</a>
