<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <a class="btn btn-outline-success my-1 my-sm-0" href="template\vist_carrito.php" style="background:url(https://icon-icons.com/icons2/606/PNG/32/shopping-cart_icon-icons.com_56125.png) no-repeat; border:none; width:32px; height:32px;" ></a>
        </form>
        <li class="nav-item">
